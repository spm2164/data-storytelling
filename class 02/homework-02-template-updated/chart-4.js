// Sean Moriarty
// Sept 21, 2016
// displays a scatterplot of weight over names, and then sized by times arrested
//(with messed up positions)
(function() {
	var data = [
	...
	var colorScale = d3.scaleLinear().range(["lightblue", "orange"]);
